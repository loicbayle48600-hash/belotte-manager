...
- Laboratoire de trading algorithmique **multi-agents autonome** relié à **MetaTrader 5**, sur **compte DEMO d'abord**
  (`config/system.yaml` → `account_expected` : login `5056132326`, serveur `MetaQuotes-Demo`, `trade_mode: DEMO`, `EUR`, hedging).
...
- [ ] Remplir `.env` : `MT5_LOGIN=5056132326`, `MT5_SERVER=MetaQuotes-Demo`, `MT5_PASSWORD` (ou connexion manuelle dans le terminal, alors
